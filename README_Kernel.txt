...
1. How to Build
        ...
        - to Build
                $ export ARCH=arm64
                $ make -C $(pwd) O=$(pwd)/out KCFLAGS=-mno-android crownqlte_chn_open_defconfig
...
3. How to Clean
        ...
        EX) /home/dpi/qb5_8814/workspace/P4_1716/android/out/target/product/crownqltechn/out
        $ make clean
################################################################################
